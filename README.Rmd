...
This package aims to secure your R package against insecure dependencies using the [OSS Index](https://ossindex.sonatype.org/). Essentially, we check R packages for
...
Remember to add {oysteR} as a Suggested package in your DESCRIPTION file.
